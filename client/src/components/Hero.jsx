        ...
        <div className="h-[calc(100vh-4rem)] flex items-center justify-center text-center">
          <div className="space-y-6">
            ...
            <div className="relative inline-block">
              ...
              <div className="relative inline-block rounded-[2rem] p-[2px] bg-gradient-to-r from-blue-500 via-pink-500 to-purple-500">
                <div className="rounded-[2rem] bg-zinc-950 px-8 py-4">
                  ...
                  {!done && (
                    <span className="ml-1 inline-block w-[2px] h-[1em] bg-white/90 align-[-0.12em] animate-pulse" />
                  )}
                </div>
              </div>
              {/* Gentle glow when finished */}
              <div
                className={`pointer-events-none absolute -inset-5 rounded-[2.4rem] bg-gradient-to-r from-blue-500 via-pink-500 to-purple-500 blur-3xl transition-opacity duration-700 ${
                  done ? "opacity-50" : "opacity-0"
                }`}
              />
            </div>
